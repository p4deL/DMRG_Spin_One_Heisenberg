    ...
    def init_terms(self, model_params):
        ...
        if math.isinf(alpha):
            ...
            for u1, u2, dx in self.lat.pairs['nearest_neighbors']:
                ...
                self.add_coupling(Jz*(1. - Gamma), u1, 'Sz', u2, 'Sz', dx)
            ...
            for pr, la in zip(pref, lam):
                ...
                self.add_exponentially_decaying_coupling(Jz*prprime, laprime, 'Sz', 'Sz', subsites=even_sites)
                ...
                self.add_exponentially_decaying_coupling(Jz*prprime, laprime, 'Sz', 'Sz', subsites=odd_sites)